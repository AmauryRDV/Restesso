 ...
 */
final class Version20240221200929 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE category CHANGE status status VARCHAR(15) NOT NULL');
        $this->addSql('ALTER TABLE loaded_file CHANGE status status VARCHAR(255) NOT NULL');
        $this->addSql('ALTER TABLE coffee CHANGE status status VARCHAR(15) NOT NULL');
    }
}
